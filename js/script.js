...
//        }
        ...
        var formData = new FormData($('.contactForm #form1'));

        for (var i = 0, len = document.getElementById('documents1').files.length; i < len; i++) {
            formData.append("documents1"+(i+1), document.getElementById('documents1').files[i]);
        }
        ...
        $.ajax({
            type: "POST",
            url: $('.contactForm #form1').attr('action'),
            data: formData,
            dataType : 'json',
            async : true,
...
//        }
        ...
        $.ajax({
            type: "POST",
            url: $('.contactForm #form2').attr('action'),
            data: data_string,
...
//        }
        ...
        $.ajax({
            type: "POST",
            url: $('.contactForm #form3').attr('action'),
            data: data_string,
...
//        }
        ...
        $.ajax({
            type: "POST",
            url: $('.contactForm #form4').attr('action'),
            data: data_string,
...
//        }
        ...
        $.ajax({
            type: "POST",
            url: $('.contactForm #form5').attr('action'),
            data: data_string,
...
//        }
        ...
        $.ajax({
            type: "POST",
            url: $('.contactForm #form6').attr('action'),
            data: data_string,
