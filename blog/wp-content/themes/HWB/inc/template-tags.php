...
if ( ! function_exists( 'hbw_posted_on' ) ) :
/**
 ...
 * @return void
 */
    function hbw_posted_on() {
//        <a href="%1$s" rel="bookmark">
            printf('<div class="postMeta "><div class="metaIco"><i class="icon-calendar"></i></div><div class="metaInner"><span class="month">%1$s</span><span class="day">%2$s</span></div></div>',
...
if(! function_exists('hwb_author')):

    function hwb_author(){
          printf('<span class="metaAuthor">Posted by: <a href="%1$s" rel="author">%2$s</a></span>',
              esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
              get_the_author()
          );
    }
